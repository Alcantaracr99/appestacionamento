...
Crie um schema de banco de dados no MySql com o nome app_estacionamento. O arquivo .env do projeto estará configurado para a estrutura padrão do MySql. Caso o seu banco tenha um outro nome de usuário e senha. Deixe com o padrão root e sem senha.;

Dentro do projeto execute o seguinte comando:
    
    $ php artisan migrate --seed

Verifique se todas as tabelas foram criadas e se algumas delas tem informações carregadas, conforme o arquivo localizado no ./database/seeders/DatabaseSeeder.php

Após a criação do banco de dados para inicializar o projeto basta executar o seguinte comando:
